...
Therefore, our method is computationally efficient, applicable for dense or irregular functional data, and keeps the residual smooth, as it enforces  $\hat{\delta}^{[l]}$  as an element of $\widetilde{\mathbb{H}}$ as defined in Equation \eqref{def:truncated_hilbert_space}.
...
\subsection{Proof of Propositions \ref{proposition:eigen_noregul} and \ref{proposition:eigen_regul} }\label{section:proof:proposition:linear_regul_system_unregularized}
\begin{proof}
