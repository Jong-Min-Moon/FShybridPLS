...
At the $l$-th iteration of the PLS algorithm, the unit-norm direction in $(\mathcal{B}^K \times \mathbb{R}^p) \subset \mathcal{H}$ that maximizes the squared empirical covariance \eqref{def:squared_empirical_cov} is the solution to the following generalized eigenvalue problem:
\begin{align}
	\left(
