...
This stretagey fully leverages both the continuous nature of the functional components and the function-scalar hybrid structure, and can be implemented via simple matrix-vector multiplications. Building on this strategy, Section \ref{sec: Regularization of PLS Components} presents the estimation procedure for our suggest method.
...
is provided in Appendix \ref{section:proof:proposition:linear_noregul_system_unregularized}.
...
\end{equation*}
\end{proposition}
The proof of Proposition \ref{proposition:linear_noregul}  is provided in Appendix \ref{section:proof:proposition:linear_noregul}.
...
Therefore, the optimization problem \eqref{optim:summation_form}, which is equivalent to the squared covariance maximization problem, reduces to the generalized eigenvalue problem \eqref{eq: Regularized generalized rayleigh quotient equation}. This completes the proof of Proposition~\ref{proposition:eigen_noregul}.
 ...
 \section{Proof of Proposition  \ref{proposition:linear_noregul}}\label{section:proof:proposition:linear_noregul}
 \begin{proof}
