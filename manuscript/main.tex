...
The $l$-th iteration's second step involves orthogonalization. This is achieved by fitting a hybrid-on-scalar regression model, where the predictor is the PLS score for each observation. The individual PLS score is computed as  
...
The following proposition shows that the solution of the problem \ref{def:argmin_pensse} can be obtained by solving linear equations.
 ...
 \begin{proposition}[Closed-form  solution]\label{proposition:closed_form_orthgonalization}
 	Let us denote
 	\begin{equation*}
...
\end{equation*}
 ...
 Now we formally state the orthogonalization step.
