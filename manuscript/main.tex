...
\begin{document}
	...
	\begin{equation*}
		...
		Z^\top \mathbf{y}.
	\end{equation*}
These expressions represent matrix–vector multiplications normalized by a common factor. 
	The derivation of this formula is provided in Appendix~\ref{section:proof:Proposition:linear_system_unregularized}.
