...
\bigr)   \in \mathcal{F}^{\otimes K},
	\end{equation*}
between the response and the scalar predictor:
\begin{equation*}
\sigma_{YZ} 
= 
...
The proof of Lemma \ref{lemma:composite_cross_cov} is provided in Appendix \ref{section:proof:lemma:composite_cross_cov}.
 The following proposition presents several important properties of $\mathcal{U}$.
	\begin{proposition} \label{Proposition: property of U}
	 Furthermore, if there exist finite constants $Q_1$ and $Q_2$ such that
		\begin{align}
