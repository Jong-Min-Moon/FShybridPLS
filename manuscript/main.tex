...
\begin{equation}	\label{eq: functional model}
	...
	\sum 
	\limits_{k=1}^K 
	\int  \beta_j(t) X_{ik}(t) dt + \epsilon_i,
	\quad
	i = 1, \ldots, n,
...
\begin{proposition}\label{proposition: modified orthnormality of PLS components}\jongmin{currently revising}
...
Now let $\widehat{\boldsymbol{\rho}}_l=(\widehat{\rho}_{1l}, \ldots, \widehat{\rho}_{nl})^\top$ denote the $n$-dimensional vector whose elements consist of estimated $l$-th PLS scores ($l=1, \ldots, L)$ of $n$ observations. 
...
The next proposition states that the vectors of estimated PLS scores $\widehat{\boldsymbol{\rho}}_1, \widehat{\boldsymbol{\rho}}_2, \ldots, \widehat{\boldsymbol{\rho}}_L$ obtained from the proposed algorithm are mutually orthogonal.
