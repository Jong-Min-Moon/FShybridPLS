...
To guarantee the existence of a complete orthonormal system of eigenfunctions for $\mathcal{U}$ in $\mathcal{H}$, we  first demonstrate that $\mathcal{U}$ is compact.
