...
Here, $c$ represents a scalar that condenses all multiplicative terms preceding $\mathbf{y}^\top$.
		...
		\begin{align*}
			...
			\rangle_{\mathcal{H}},
		\end{align*}
where the last equality uses the computation of the $i$th entry in \eqref{score_inner_product_all_n}. To expand the last quantity, we use a recursive relationship derived as follows.
\begin{align*}
