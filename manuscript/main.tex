...
First, $\mathcal{C}_{YW}= \mathbb{E}(W_1 \otimes_\mathcal{H} Y_1): \mathcal{H} \rightarrow \mathbb{R}$ 
maps  
...
\end{equation*}
Next, $\mathcal{C}_{WY} = \mathbb{E}[Y \otimes W]: \mathbb{R} \rightarrow \mathcal{H}$
maps  $d \in \mathbb{R}$ to a hybrid object in $\mathcal{H}$ as follows:
%%%%
\begin{align*}		
\mathcal{C}_{WY} d 
:= 
...
\begin{proposition}[Existence of Maximizer for Covariance]\label{proposition: eigenanalysis} Under the conditions of Proposition \ref{proposition:compact_operator}, the constrained maximum
	\begin{equation*} 
