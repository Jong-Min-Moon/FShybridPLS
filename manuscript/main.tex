...
Although the unnormalized coefficients are computed separately for the functional and scalar part of the PLS component direction, the normalization step couples them, allowing the components to influence each other. This enables the procedure to account for the correlation between functional and scalar components.
	...
	\subsection{Proof of Propositions \ref{proposition:eigen_noregul} and \ref{proposition:linear_noregul} }\label{section:proof:proposition:linear_noregul_system_unregularized}
	\begin{comment}
	...
	presented in Proposition \ref{proposition:linear_noregul_system_unregularized} is equivalent to the following constrained optimization problem on the Euclidean space:
	\begin{align*}
	...
	\begin{equation*}
		...
		Z^\top \mathbf{y},
	\end{equation*}
	which are the same as  $\hat{\mathbf{d}}_1, \ldots, \hat{\mathbf{d}}_K$ and $\hat{\boldsymbol{\zeta}}$. This completes the proof of  Proposition \ref{proposition:linear_noregul_system_unregularized}.
