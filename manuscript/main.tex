...
\begin{lemma}\label{lemma:tau_ast}
	Let the cross-covariance between the response $Y$ and the hybrid predictor $W$ be
	\[
	\Sigma_{YW} := \mathbb{E}[ Y_1 W_1 ]
	= \bigl( \sigma_{YX,1}, \ldots, \sigma_{YX,K}, \, \sigma_{YZ} \bigr) 
	\in \mathbb{H}.
	\]
	Define the linear operator $\mathcal{T}: \mathbb{H} \to \mathbb{R}$ by
	\[
	\mathcal{T} g := \langle W_1, g \rangle_{\mathbb{H}}, \quad g \in \mathbb{H}.
	\]
	Let $\mathcal{T}^\ast: \mathbb{R} \to \mathbb{H}$ denote its adjoint operator. Then,
	\[
	\mathbb{E}[ \mathcal{T}^\ast Y_1 ] = \Sigma_{YW}.
	\]
\end{lemma}
...
for all $g \in \mathbb{H}$, we have
\begin{align*}
	 \langle
	\Sigma_{YW}, g \rangle_{\mathbb{H}} 
=	
	 \langle
	 \mathbb{E}
	 [ Y_1 W_1], g \rangle_{\mathbb{H}} 
	=
\mathbb{E}
[ Y_1 \langle W_1, g \rangle_{\mathbb{H}} ]
=
\mathbb{E}[
Y_1
(\mathcal{T}g)
...
=
\mathbb{E}[
\langle \mathcal{T}g, Y_1 \rangle
]
&= \mathbb{E}[
\langle g, \mathcal{T}^\ast Y_1 \rangle_{\mathbb{H}}
]
\\&= 
\langle g, \mathbb{E}[\mathcal{T}^\ast Y_1 ]\rangle_{\mathbb{H}}.
\end{align*}	
This completes the proof of Lemma \ref{lemma:tau_ast}.
	\end{proof}
