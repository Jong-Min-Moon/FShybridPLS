...
\end{equation}
and construct the full design matrix $\Theta := (\Theta_1, \ldots, \Theta_K, Z) \in \mathbb{R}^{n \times (MK + p)}$. Let us denote the response vector as $\mathbf{y} := (y_1, \ldots, y_n)^\top$.
