...
- Univariate Expansions
  ...
  - The following basis representations are supported: \itemize{\item Given basis
...
#' same domain as \code{mFData}, containing the given basis functions. 
The
...
#' supplied, they are calculated using the given basis functions.
The parameter
